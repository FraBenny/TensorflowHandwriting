...
class CharRecognizer(object):
    ...
    def build_model(self, nb_classes=62, nb_filters=32, kernel_size=(3, 3), pool_size=(2, 2), input_shape=(3, 224, 224)):
        ...
        bottomModel.add(ZeroPadding2D((1, 1), input_shape=(3, 224, 224)))
        bottomModel.add(Convolution2D(64, 3, strides=(3,3), activation='relu', name='conv1_1', data_format = 'channels_first'))
        bottomModel.add(ZeroPadding2D((1, 1)))
        bottomModel.add(Convolution2D(64, 3, strides=(3,3), activation='relu', name='conv1_2'))
        bottomModel.add(MaxPooling2D((2, 2), strides=(2, 2)))

        bottomModel.add(ZeroPadding2D((1, 1)))
        bottomModel.add(Convolution2D(128, 3, strides=(3,3), activation='relu', name='conv2_1'))
        bottomModel.add(ZeroPadding2D((1, 1)))
        bottomModel.add(Convolution2D(128, 3, strides=(3,3), activation='relu', name='conv2_2'))
        bottomModel.add(MaxPooling2D((2, 2), strides=(2, 2)))

        bottomModel.add(ZeroPadding2D((1, 1)))
        bottomModel.add(Convolution2D(256, 3, strides=(3,3), activation='relu', name='conv3_1'))
        bottomModel.add(ZeroPadding2D((1, 1)))
        bottomModel.add(Convolution2D(256, 3, strides=(3,3), activation='relu', name='conv3_2'))
        bottomModel.add(ZeroPadding2D((1, 1)))
        bottomModel.add(Convolution2D(256, 3, strides=(3,3), activation='relu', name='conv3_3'))
        bottomModel.add(MaxPooling2D((2, 2), strides=(2, 2)))

        bottomModel.add(ZeroPadding2D((1, 1)))
        bottomModel.add(Convolution2D(512, 3, strides=(3,3), activation='relu', name='conv4_1'))
        bottomModel.add(ZeroPadding2D((1, 1)))
        bottomModel.add(Convolution2D(512, 3, strides=(3,3), activation='relu', name='conv4_2'))
        bottomModel.add(ZeroPadding2D((1, 1)))
        bottomModel.add(Convolution2D(512, 3, strides=(3,3), activation='relu', name='conv4_3'))
        bottomModel.add(MaxPooling2D((2, 2), strides=(2, 2)))

        bottomModel.add(ZeroPadding2D((1, 1)))
        bottomModel.add(Convolution2D(512, 3, strides=(3,3), activation='relu', name='conv5_1'))
        bottomModel.add(ZeroPadding2D((1, 1)))
        bottomModel.add(Convolution2D(512, 3, strides=(3,3), activation='relu', name='conv5_2'))
        bottomModel.add(ZeroPadding2D((1, 1)))
        bottomModel.add(Convolution2D(512, 3, strides=(3,3), activation='relu', name='conv5_3'))
